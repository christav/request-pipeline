...
//
// Functions dealing with the request library specifically
//

var request = require('request');

/**
 * Sink function that sends the final filtered result out via the request library.
 *
 * @private
...
exports.sink = requestLibrarySink;
